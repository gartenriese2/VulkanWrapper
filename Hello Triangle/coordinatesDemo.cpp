...
namespace bmvk
{
    const std::string K_VERTEX_SHADER_PATH{ "../shaders/coordinatesDemo/vertex.vert.spv" };
    const std::string K_COLOR_FRAGMENT_SHADER_PATH{ "../shaders/coordinatesDemo/color.frag.spv" };
    const std::string K_NORMAL_FRAGMENT_SHADER_PATH{ "../shaders/coordinatesDemo/normal.frag.spv" };
    const std::string K_WORLDNORMAL_FRAGMENT_SHADER_PATH{ "../shaders/coordinatesDemo/worldNormal.frag.spv" };
    const std::string K_VIEWPOS_FRAGMENT_SHADER_PATH{ "../shaders/coordinatesDemo/viewPos.frag.spv" };
